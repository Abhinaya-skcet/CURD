...
export default function SimplePaper() {
  return (
    ...
    >
      ...
      <form>
      <Typography>Name: <input type="text"></input></Typography>
      <Typography>Age:  <input type="text"></input></Typography>
      <tr>
      <td><Typography><input type="radio"  name="age" id="Male" value="se"/>
      <label for="Male">Male</label></Typography></td>
      <td><Typography><input type="radio" name="age" id="Female" value="se"/>
      <label for="Female">Female</label></Typography></td>
      </tr>
      <Typography>
      <label for="phone">Enter a phone number:</label>
     <input type="tel" id="phone" name="phone"  pattern="[0-9]{3}-[0-9]{2}-[0-9]{3}" required></input></Typography>
      </form>
      </Paper>
    </Box>
    </center>
    ...
    <td width='450px'><Paper elevation={5} >
